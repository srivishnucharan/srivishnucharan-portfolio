...
export default function Home() {
  ...
  return (
    <div className="flex-grow">
      {/* Hero Section */}
      <section className="py-20 sm:py-28 bg-zinc-900/10">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          {/* Left Column */}
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 rounded-full border border-orange-500/20 bg-orange-500/5 px-3 py-1 text-[11px] uppercase tracking-[0.15em] font-mono text-orange-500">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <a
                ...
                className="inline-flex items-center justify-center font-semibold rounded-full border border-transparent transition-all duration-200 hover:scale-105 shadow-sm px-6 py-3 text-sm text-zinc-950 bg-white hover:bg-zinc-100"
              >
                Book a conversation
              </a>
              <Link
                href="/portfolio"
                className="inline-flex items-center justify-center font-semibold rounded-full border border-zinc-800 hover:border-zinc-700 hover:bg-zinc-900/50 transition-all duration-200 hover:scale-105 shadow-sm px-6 py-3 text-sm text-zinc-300"
              >
                View my work
              </Link>
            </div>
            {/* Quick Hero Stats */}
            <div className="flex flex-wrap gap-6 pt-6 border-t border-zinc-900 text-sm font-mono text-zinc-500">
              <div>
                <strong className="text-white font-bold block text-lg font-sans">23+ Years</strong>
                experience
              </div>
              <div className="border-l border-zinc-900 pl-6">
                <strong className="text-white font-bold block text-lg font-sans">Ex-Verizon</strong>
                Associate Director
              </div>
              <div className="border-l border-zinc-900 pl-6">
                <strong className="text-white font-bold block text-lg font-sans">B.E.</strong>
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="w-full max-w-[360px] rounded-3xl border border-zinc-800 bg-zinc-900/30 p-8 shadow-2xl relative overflow-hidden">
              {/* Radial glow background */}
              <div className="absolute inset-0 bg-gradient-to-tr from-orange-500/10 to-transparent blur-2xl pointer-events-none" />
              <div className="text-[10px] font-mono uppercase tracking-wider text-zinc-600 mb-2">Technical Core</div>
              ...
              <svg viewBox="0 0 320 260" className="w-full h-auto">
                ...
                {/* Lines */}
                <line x1="137" y1="107" x2="75" y2="65" stroke="rgba(255,255,255,0.06)" stroke-width="1.5" />
                <line x1="183" y1="107" x2="245" y2="65" stroke="rgba(255,255,255,0.06)" stroke-width="1.5" />
                <line x1="128" y1="130" x2="92" y2="130" stroke="rgba(255,255,255,0.06)" stroke-width="1.5" />
                <line x1="192" y1="130" x2="228" y2="130" stroke="rgba(255,255,255,0.06)" stroke-width="1.5" />
                <line x1="160" y1="162" x2="160" y2="203" stroke="rgba(255,255,255,0.06)" stroke-width="1.5" />

                {/* Nodes */}
                <g>
                  <rect x="35" y="36" width="80" height="28" rx="14" fill="rgba(255,255,255,0.03)" stroke="rgba(255,255,255,0.08)" stroke-width="1" />
                  <text x="75" y="51" font-size="11" fill="rgba(255,255,255,0.75)" font-weight="600" text-anchor="middle" dominant-baseline="middle">AI SDLC</text>
                </g>
                <g>
                  <rect x="205" y="36" width="80" height="28" rx="14" fill="rgba(255,255,255,0.03)" stroke="rgba(255,255,255,0.08)" stroke-width="1" />
                  <text x="245" y="51" font-size="11" fill="rgba(255,255,255,0.75)" font-weight="600" text-anchor="middle" dominant-baseline="middle">Quality Eng</text>
                </g>
                <g>
                  <rect x="10" y="116" width="80" height="28" rx="14" fill="rgba(255,255,255,0.03)" stroke="rgba(255,255,255,0.08)" stroke-width="1" />
                  <text x="50" y="131" font-size="11" fill="rgba(255,255,255,0.75)" font-weight="600" text-anchor="middle" dominant-baseline="middle">Platform Mod</text>
                </g>
                <g>
                  <rect x="230" y="116" width="80" height="28" rx="14" fill="rgba(255,255,255,0.03)" stroke="rgba(255,255,255,0.08)" stroke-width="1" />
                  <text x="270" y="131" font-size="11" fill="rgba(255,255,255,0.75)" font-weight="600" text-anchor="middle" dominant-baseline="middle">Enterprise Tr</text>
                </g>
                <g>
                  <rect x="110" y="205" width="100" height="28" rx="14" fill="rgba(255,255,255,0.03)" stroke="rgba(255,255,255,0.08)" stroke-width="1" />
                  <text x="160" y="220" font-size="11" fill="rgba(255,255,255,0.75)" font-weight="600" text-anchor="middle" dominant-baseline="middle">RPA Bots</text>
                </g>
              </svg>
            </div>
          </div>
      ...
      <section className="py-12 border-b border-zinc-900 bg-background">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 grid grid-cols-2 md:grid-cols-4 gap-8">
          {stats.map((stat, idx) => (
            <div key={idx} className="space-y-1">
              <div className="text-3xl font-extrabold text-orange-500 tracking-tight">{stat.num}</div>
              <div className="text-xs text-zinc-300 font-medium leading-snug">{stat.label}</div>
              <div className="text-[10px] text-zinc-500 font-mono">{stat.source}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="py-24 bg-zinc-900/10 border-b border-zinc-900">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-4 space-y-4">
            <div className="text-[11px] uppercase tracking-[0.2em] font-mono font-bold text-orange-500">Experience</div>
            <h2 className="text-3xl font-bold tracking-tight text-white">Where I've done this.</h2>
          ...
          <div className="lg:col-span-8 space-y-6">
            {experience.map((item, idx) => (
              <div
                key={idx}
                className="p-6 rounded-2xl border border-zinc-900 bg-zinc-900/30 hover:bg-zinc-900/50 transition-colors duration-300 flex items-start gap-5"
              >
                <div className="w-12 h-12 rounded-xl bg-orange-500/10 flex items-center justify-center shrink-0">
                  <IconBriefcase className="text-orange-500" size={24} />
                </div>
                <div className="space-y-2">
                  ...
                  <div className="text-sm font-semibold text-orange-500">{item.role}</div>
                  <p className="text-sm text-zinc-400 leading-relaxed">{item.desc}</p>
                </div>
              </div>
            ))}
            <div className="pt-4 text-center lg:text-left">
              <Link href="/cv" className="text-sm font-bold text-white hover:text-orange-500 transition-colors inline-flex items-center gap-1.5">
      ...
      {/* Services Preview */}
      <section className="py-24 bg-background border-b border-zinc-900">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 space-y-12">
          <div className="flex flex-wrap justify-between items-end gap-6">
            <div className="space-y-4">
              ...
              <h2 className="text-3xl font-bold tracking-tight text-white">What I can do for your team.</h2>
            </div>
            <Link href="/services" className="text-sm font-bold text-white hover:text-orange-500 transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {services.map((item, idx) => (
              <div
                key={idx}
                className="p-8 rounded-3xl border border-zinc-900 bg-zinc-900/30 shadow-sm flex flex-col justify-between h-full space-y-6 hover:bg-zinc-900/50 transition-colors duration-300"
              >
                <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-1.5 pt-4 border-t border-zinc-900/50">
                  {item.tags.map((tag) => (
                    <span key={tag} className="text-[10px] font-mono px-2.5 py-1 bg-zinc-800 text-zinc-300 rounded">
                      {tag}
                    </span>
                  ))}
                </div>
      ...
      <section id="about" className="py-24 bg-zinc-900/10">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-6">
            <div className="text-[11px] uppercase tracking-[0.2em] font-mono font-bold text-orange-500">About</div>
            ...
            <div className="flex gap-6 pt-4 font-mono text-sm">
              <Link href="/cv" className="text-white font-bold hover:text-orange-500 transition-colors">
                Read my full CV &rarr;
              </Link>
              <Link href="/contact" className="text-white font-bold hover:text-orange-500 transition-colors">
                Get in touch &rarr;
              </Link>
            </div>
          </div>
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative w-full max-w-[340px] aspect-[4/5] rounded-[2rem] overflow-hidden border-8 border-zinc-900 shadow-2xl bg-zinc-900/50">
              <img
                src="/MyPicture.png"
        ...
        <div className="max-w-4xl mx-auto px-6 text-center space-y-6 relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4 pt-4">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center font-semibold text-white border border-zinc-800 rounded-full hover:bg-zinc-900/50 transition-all duration-200 hover:scale-105 shadow-sm px-6 py-3 text-sm"
            >
              View LinkedIn Profile
            </a>
          </div>
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-2 pt-8 text-xs font-mono text-zinc-600 border-t border-zinc-900/50">
