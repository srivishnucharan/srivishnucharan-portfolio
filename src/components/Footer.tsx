      ...
      <div className="max-w-7xl mx-auto px-6 py-12 sm:px-8 lg:py-16">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 md:gap-12">
          <div className="col-span-2 md:col-span-2 flex flex-col items-start">
            <Link href="/" className="text-xl font-bold tracking-tight text-white mb-4">
              Srivishnu Charan
            </Link>
          ...
          <div className="col-span-1">
            <h3 className="text-xs font-semibold text-zinc-500 tracking-wider uppercase">About</h3>
            <ul className="mt-4 flex flex-col space-y-3">
              ...
              <li>
                <Link href="/cv" className="text-zinc-400 hover:text-orange-500 transition-colors text-sm">
                  CV
                </Link>
              </li>
              <li>
          ...
          <div className="col-span-1">
            <h3 className="text-xs font-semibold text-zinc-500 tracking-wider uppercase">Work</h3>
            <ul className="mt-4 flex flex-col space-y-3">
              <li>
              ...
              <li>
                <Link href="/portfolio" className="text-zinc-400 hover:text-orange-500 transition-colors text-sm">
                  Portfolio
                </Link>
              </li>
            </ul>
          ...
          <div className="col-span-1">
            <h3 className="text-xs font-semibold text-zinc-500 tracking-wider uppercase">Connect</h3>
          ...
          <div className="col-span-1">
            <h3 className="text-xs font-semibold text-zinc-500 tracking-wider uppercase">Repo</h3>
            <div className="mt-4 flex flex-col space-y-3">
              <a
        ...
        <div className="mt-12 border-t border-zinc-900 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 md:gap-4">
            <div className="flex flex-col gap-1">
              <p className="text-xs text-zinc-500">&copy; {new Date().getFullYear()} Srivishnu Charan Avasarala. All rights reserved.</p>
            </div>
